...
let CitiesController = class CitiesController {
    ...
    async getPopularCities(query = '') {
        return this.citiesService.getPopularCities(query);
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Returns a list of popular cities' }),
    __param(0, (0, common_1.Query)('q')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], CitiesController.prototype, "getPopularCities", null);
